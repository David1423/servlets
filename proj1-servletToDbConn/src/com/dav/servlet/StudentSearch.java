...
public class StudentSearch extends HttpServlet {
	...
	private static final String GET_STUDENT_BY_NAME = "SELECT sname,scourse,sfee from Student where sname=?;";
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		// get printWriter obj
		pw = res.getWriter();
		pw.println("<head><link rel='icon' type='image/png' href='favicon.png'></head>");
